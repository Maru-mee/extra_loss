...
* 画像解像度512以上に合わせてチューニング済
  ...
  * そのチューニングがあるために、SD1では効果をほぼ得られません（一般的に、SD1は700pxを超過する画像を使うと破綻するため）。
  * それでも使用したい場合は手動でコードを書き換えてください。area_lower_limit_imgの値を引き下げ、かつ、細かい分割を行ういくつかのlossの機能をOFFにするなど。
